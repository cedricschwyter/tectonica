    ...
    return (
        <>
            <div id="vision" className="flex">
                <div className="flex flex-col items-center pb-24 pt-20 justify-end h-full m-2 shadow-lg rounded-xl bg-black/40 backdrop-blur-md hover:shadow-teal-600 hover:shadow-xl transition-all">
