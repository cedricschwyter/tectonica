...
export const NavBar = () => {
    return (
        <div className="grow sticky top-0 z-50 w-auto sm:mx-2 sm:mb-3 sm:top-2 bg-white/70 sm:rounded-xl navbar backdrop-blur-lg">
            <div className="navbar-start h-20">
                <div className="dropdown">
                    ...
                    <ul
                        tabIndex={0}
                        className="p-2 mt-3 shadow menu menu-compact dropdown-content bg-base-100 rounded-box"
                    >
                ...
                <NextLink className="p-2 text-3xl rounded-lg text-accent" href={"/"}>
