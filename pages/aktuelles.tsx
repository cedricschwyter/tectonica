...
const cardItems = [
    ...
    },
    {
        ...
        image: '/img/2006_Wilstrasse_Duebendorf.jpg'
    },
    {
    ...
    {
        projectName: 'EAH Hotel 25 Hours',
        description: 'description',
...
const Aktuelles = () => {
    ...
    let classNames = "flex flex-col w-full m-1 sm:translate-y-0 translate-y-1/4 rounded-2xl sm:m-0";

    if (cardItems[index].image) {
        classNames += " sm:translate-x-1/3 2xl:translate-x-[16.666667%]";
    }
