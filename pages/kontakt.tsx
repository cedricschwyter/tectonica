    ...
    let Form = () => {
        return (<>
            <form className="flex flex-col items-center w-full h-full gap-2 text-white" method='post' onSubmit={handleSubmit} id="contact-form">
                <input type="email" placeholder="E-Mail Adresse" id="email" name="email" className="w-full max-w-xs input input-ghost " />
            ...
            <div className="flex flex-col text-white items-center">
                ...
                <div>
                    E-Mail: {' '}
                    <a href="mailto:info@tectonica-bau.ch">
                        info@tectonica-bau.ch
                    </a>
                </div>
            </div>
        </>
    ...
    let FormError = () => {
        return (
            <div className="m-4 text-2xl text-center text-white grow">
                ...
                Bitte kontaktieren Sie uns direkt unter <a href="mailto:info@tectonica-bau.ch">info@tectonica-bau.ch</a>.
            </div>
        );
    };
